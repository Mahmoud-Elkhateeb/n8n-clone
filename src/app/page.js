...
export default function Home() {
  const cards = [
    {
      ...
      img: "/images/Home_ITO_Ps_5a5aac3fda.webp", // put your images in public folder
    },
    {
      title: "Sec Ops",
      desc: "⚡ Enrich security incident tickets",
      img: "/images/Home_Sec_O_Ps_1553ddb39b.webp",
    },
    {
      title: "Dev Ops",
      desc: "⚡ Convert natural language into API calls",
      img: "/images/Home_Dev_O_Ps_43aa01a07b.webp",
    },
    {
      title: "Sales",
      desc: "⚡ Generate customer insights from reviews",
      img: "/images/Home_Sales_d1992221c7.webp",
    },
    {
      title: "You",
      desc: "▶ Watch this video to hear our pitch",
      img: "/images/Home_Dev_O_Ps_43aa01a07b.webp",
    },
  ];
  ...
  const companySets = [
    [
      { name: "vodafone", logo: "/images/re_vodafone_6deed71a6c.svg" },
      { name: "Mistral AI", logo: "/images/re_mistral_ai_cf1ceddcce.svg" },
      { name: "zendesk", logo: "/images/zendesk_136788a158_6d4c59b139.svg" },
      { name: "Delivery Hero", logo: "/images/re_delivery_hero_2f29c05551.svg" },
    ],
    [
      { name: "deda.tech", logo: "/images/re_dedatech_18e7e6253b.svg" },
      { name: "Unbabel", logo: "/images/unbabel_1392f8b8ac_cca31eda86.svg" },
      { name: "Microsoft", logo: "/images/microsoft_a60b0da7d8.svg" },
      { name: "vodafone", logo: "/images/re_vodafone_6deed71a6c.svg" },
    ],
  ];
  ...
  const proofs = [
    {
      ...
      gradientClass: "bg-gradient-to-r from-[#1A1020] to-[#4C3044]  ",
      imgSrc:
      ...
      text: (
        <>
          ...
          Our 122.8k stars place us among the most popular projects.
        </>
      ),
    },
    {
      href: "https://www.g2.com/products/n8n/reviews",
      gradientClass: "bg-gradient-to-r from-[#361923] via-[#462F4E] to-[#221426]",
      imgSrc:
        "/images/VS_Code_Dark_1_ab4a2bad7b.svg",
      text: (
        <>
          <strong className="font-semibold text-white">
            4.9/5 stars on G2.
    ...
    },
    {
      ...
      gradientClass: "bg-gradient-to-r from-[#36183F] via-[#5F3830] to-[#1B1120]",
      imgSrc:
        "/images/social_proof_2_14745833f3.svg",
      text: (
        <>
          <strong className="font-semibold text-white">
  ...
  const icons = [
    "/images/66f4d7cc8fbc5fb41664b4ba_aggregate_svg_920d36c8b1.svg",
    "/images/66f4d7cc51d72b9903df9fde_amqp_svg_ebc4c3b32a.svg",
    "/images/66f4d7cdc905e0766217414a_ai_Transform_svg_295de265a2.svg",
    "/images/66f4d7cdc905e0766217414a_ai_Transform_svg_295de265a2.svg",
    "/images/66f4d7cdc905e0766217414a_ai_Transform_svg_295de265a2.svg",
    "/images/66f4d7cdc905e0766217414a_ai_Transform_svg_295de265a2.svg",
    "/images/66f4d7cdc905e0766217414a_ai_Transform_svg_295de265a2.svg",
  ...
  // SVG Icons
  const FeatureIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="text-[#828282] shrink-0" width="24" height="24" viewBox="0 0 24 24">
      <g fill="none">
  ...
  // Data
  const featureItems = [
    { text: '<strong>Write JavaScript or Python</strong> - you can always fall back to code' },
    { text: '<strong>Add libraries</strong> from npm or Python for even more power' },
    { text: '<strong>Paste cURL requests</strong> into your workflow' },
    { text: '<strong>Merge workflow branches</strong>, don’t just split them' },
  ];

  const runTweakItems = [
    { text: '<strong >Re-run single steps</strong> without re-running the whole workflow' },
    { text: '<strong>Replay or mock data</strong> to avoid waiting for external systems' },
    { text: '<strong>Debug fast</strong>, with logs in line with your code' },
    { text: '<strong>Use 1700+ templates</strong> to jump-start your project' },
  ];
  ...
  return (
    <main className="flex justify-center flex-col">
        ...
        <div className="flex flex-col items-center justify-center w-full sm:w-[55%] p-5 text-white relative z-20 sm:text-center">
          <div className="lg:text-left sm:text-center  max-w-full mt-30">
            <h1
              ...
              data-aos-delay="700"
              className="text-[35px] font-[600] text-5xl  
      bg-gradient-to-r from-[#ffffff] via-[#b5b3f3] to-[#8e88f5] 
      bg-[length:200%_auto] 
      text-transparent bg-clip-text 
      animate-gradient">Flexible AI Workflow Automation <span className="
        bg-gradient-to-r from-[#ff6a00] via-[#ff8c00] to-[#ffb347]
        bg-[length:200%_auto]
        text-transparent bg-clip-text
        animate-gradient"
              >for technical teams</span></h1>
            <p className="text-[1.1rem] my-9 text-[#B8B0C7]"
              data-aos="fade-up"
              data-aos-duration="2000"
              data-aos-delay="1000">Build with the precision of code or the speed of drag-n-drop. Host with on-prem control or in-the-cloud convenience. n8n gives you more freedom to implement multi-step AI agents and integrate apps than any other tool.
            ...
            {cards.map((card, index) => (
              <div key={index} className="w-full md:w-auto flex flex-col items-center">
                <div
                  ...
                  className="
                  w-full md:w-[194px] sm:w-[170px] md:max-w-[200px]
                ...
                >
                  <h3 className="text-lg font-bold">
                    {card.title} <span className="text-orange-400">can</span>
                  </h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 "
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-[19px]  text-[#9F9DA3] mb-1">
      ...
      {/* /////////////////////////////////////////////////////////////////// */}
      {/* fourth-section */}
      <div className=" flex flex-col items-center justify-center gap-2 px-2 md:px-0 lg:flex-row position-relative z-10 md:mt-[-240px] sm:mt-[90px] mt-[50px]"
        data-aos="fade-up"
        data-aos-duration="2000"
        data-aos-delay="200">
      ...
      <header className="flex flex-col mb-12 lg:mb-16 xl:mb-22 gap-y-4 items-center mt-30"
        ...
        bg-gradient-to-r from-[#F2F2F3]  to-[#8777A3] bg-clip-text text-transparent font-[500]
      ">
          Plug AI into your own data &amp;{" "}
          <span className="bg-gradient-to-r from-[#FD9526]  to-[#EF5327] bg-clip-text text-transparent mt-0">
      ...
      <header className="flex flex-col mb-12 lg:mb-16 xl:mb-7 gap-y-4 items-center mt-35 z-6"
        ...
        text-3xl md:text-5xl lg:text-[47px] 
        text-center flex flex-col items-center max-w-[800px] 
        bg-gradient-to-r from-[#AEAAB8]  to-[#706385] bg-clip-text text-transparent font-[600]
      ">
          The fast way to actually
          <span className="bg-gradient-to-r from-[#CF7926]  to-[#C24324] bg-clip-text text-transparent mt-1">
      ...
      >
        <div className="max-w-screen-xl mx-auto w-full sm-w-full md:w-full lg:w-[95%] xl:w-[58%]">
          <div className="grid grid-cols-1 gap-2 md:grid-cols-2 ">
            ...
            <div
              ref={card1Ref}
              className="col-span-12 row-start-1 lg:col-span-4 border-1 rounded-3xl bg-gradient-to-r from-[#140D1D] via-[#714237] to-[#100B1E] relative overflow-hidden"
                    ...
                    <div className="card-content h-full w-full">
                      <div className="card-teams-agent grid h-full w-full grid-cols-1 gap-4 px-8 py-10 md:grid-cols-2 md:gap-0 md:p-0">
                        <header className="order-last flex flex-col justify-center gap-2 px-2 md:order-first md:px-10 lg:pl-10 lg:pr-0">
                          ...
                          <Link href="/ai/" className="btn items-center text-center relative justify-center px-6 font-normal whitespace-nowrap rounded-lg disabled:cursor-not-allowed btn-primary text-white tracking-[.3px] font-geomanist-book min-h-[39px] text-small-button-text mt-2 flex w-fit space-x-2">
                        ...
                        <div className="image relative">
                          <Image
                            ...
                            src="/images/teams_of_agent_e1f7b47c2f.png"
                            className="h-[240px] w-full object-cover object-center md:h-[368px] md:object-contain"
                            width={500}
                            height={368}
                            priority
                          />
            ...
            <div
              ref={card2Ref}
              className="col-span-12 md:col-span-12 lg:col-span-1 sm:col-span-12 border-1 rounded-3xl bg-gradient-to-b from-[#714237] via-[#100B1F] to-[#322232] relative overflow-hidden"
                        ...
                        <div className="flex flex-col justify-center gap-4 md:gap-6 md:px-8">
                          ...
                          <ul className="flex flex-col gap-y-3">
                            <li className="feature-item flex flex-row gap-x-2">
                              ...
                              <div className="font-geomanist text-md text-white opacity-55">
            ...
            <div
              ref={card3Ref}
              className="col-span-12 md:col-span-12 lg:col-span-3 sm:col-span-12 border-1 rounded-3xl bg-gradient-to-b from-[#714237] via-[#16111F] to-[#12192F] relative overflow-hidden"
      ...
      <section className="w-full px-4 md:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col gap-12 relative">
            {/* First Feature Block */}
            <div className="relative flex flex-col gap-y-6 overflow-hidden rounded-[17px]  bg-gradient-to-r from-[#DAE7D6] via-[#FFF9EF] to-[#BCE7D5] p-8 lg:flex-row lg:items-center lg:gap-x-20 lg:bg-white">
              ...
              data-aos="zoom-in"
                ...
                <Image
                  ...
                  width={798}
                  height={549}
                  className="effect-img w-full border-[3px] border-[black] rounded-2xl -rotate-x-10 rotate-y-20  rotate-z-3  "
                  onError={(e) => e.currentTarget.setAttribute('data-error', '1')}
                />
              </div>

              <div className="flex flex-col lg:flex-[0_0_45%] lg:pl-12 xl:pl-14">
                <h2 className="text-2xl md:text-3xl lg:text-[3rem] tracking-tight  text-black font-medium mb-2">
                  Code when you need it, UI when you don't
                </h2>
                <p className="font-[400] text-md mb-8 text-[#151413] xl:w-3/4">
                  Other tools limit you to either a visual building experience, or code. With n8n, you get the best of both worlds.
                </p>

                <ul className="flex flex-col gap-y-6 text-[#0E0918]">
            ...
            <div className="flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0E0818] p-8 lg:h-[600px] lg:flex-row lg:items-center lg:justify-between lg:px-0 lg:py-0">
              ...
              <div className="flex flex-col lg:flex-[0_0_45%] lg:pl-12 xl:pl-20">
                <div className="w-full lg:pl-2">
                  <h2 className="text-2xl md:text-3xl lg:text-[2.9rem] tracking-tighter bg-gradient-to-r from-[#F7F7F7]  to-[#818181] bg-clip-text text-transparent font-medium mb-2">
                    Run. Tweak. Repeat
                  </h2>
                  <p className="font-[400] text-[1.1rem] tracking-tighter mb-8 text-[#AEA5BC]">
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-12 md:py-16 lg:py-5">
        <div className="max-w-7xl mx-auto w-full">
          ...
          data-aos="fade-up"
            ...
            <h2 className="text-4xl md:text-4xl lg:text-[3.3rem] font-[500] text-center  bg-gradient-to-r from-[#DEDCE2]  to-[#6C5B87] bg-clip-text text-transparent">
              Case Studies
            </h2>
          </header>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-6">
            {caseStudies.map((study, index) => (
              <div
                ...
                className="relative flex flex-col overflow-hidden w-full m-auto h-full items-stretch rounded-2xl bg-gradient-to-br from-[#502C2E] to-[#130B1E] border border-white/10"
                ...
                <div
                  ...
                  style={{
                    ...
                    background: cardStates[index].size
                      ? `radial-gradient(${cardStates[index].size}px at ${cardStates[index].x}px ${cardStates[index].y}px, rgba(238, 79, 39, 0.6), rgba(107, 33, 239, 0.5), transparent 80%)`
                      : 'transparent',
                  }}
                  ...
                  <div className="mt-4">
                    <div className="relative group">
                      ...
                      >
                        ...
                        <span className="relative z-10 block px-6 py-3 rounded-xl bg-gradient-to-br from-[#502C2E] to-[#130B1E]">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="relative lg:grid lg:grid-cols-2 lg:gap-x-16 xl:grid-cols-[600px_auto] xl:gap-x-32">
            ...
            <div className="relative z-10">
              <header className="flex flex-col mb-8 gap-y-4 items-start">
                ...
                data-aos="fade-up"
                                  data-aos-duration="400"
                                  data-aos-delay="400"
                className="text-4xl md:text-5xl lg:text-[3.1rem] tracking-tighter text-shades-paragraphs font-[600] bg-gradient-to-r from-[#DEDCE2]  to-[#6C5B87] bg-clip-text text-transparent">
                ...
                data-aos="fade-up"
                                  data-aos-duration="400"
                                  data-aos-delay="600"
                className="text-[#C4BBD3] lg:max-w-[540px] text-shades-paragraphs">
              ...
              data-aos="fade-up"
                ...
                <Link
                  href="/enterprise/"
                  className="bg-violet-600 hover:bg-violet-700 text-white py-2 px-6 rounded-lg text-center font-book min-h-[39px] flex items-center justify-center"
                >
              ...
              data-aos="fade-up"
                ...
                <li className="flex flex-col gap-y-2 md:flex-row md:gap-x-6">
                  <h3 className="w-full font-[700] tracking-tighter text-white md:w-4/12 lg:w-4/12">Security</h3>
                  <div className="w-full font-[400] tracking-tighter text-[#B9B1C8] text-[1.02rem] text-shades-paragraphs md:w-8/12 lg:w-8/12">
                    <p>Fully on-prem option, SSO SAML, and LDAP, encrypted secret stores, version control, advanced RBAC permissions.</p>
                  </div>
                </li>

                <li className="flex flex-col gap-y-2 md:flex-row md:gap-x-6">
                  <h3 className="w-full font-[700] tracking-tighter text-white md:w-4/12 lg:w-4/12">Performance</h3>
                  <div className="w-full font-[400] tracking-tighter text-[#B9B1C8] text-[1.02rem] text-shades-paragraphs md:w-8/12 lg:w-8/12">
                    <p>Audit logs & log streaming to 3rd party, workflow history, custom variables, external storage.</p>
                  </div>
                </li>

                <li className="flex flex-col gap-y-2 md:flex-row md:gap-x-6">
                  <h3 className="w-full font-[700] tracking-tighter text-white md:w-4/12 lg:w-4/12">Collaboration</h3>
                  <div className="w-full font-[400] tracking-tighter text-[#B9B1C8] text-[1.02rem] text-shades-paragraphs md:w-8/12 lg:w-8/12">
                    <p>Git Control, isolated environments, multi-user workflows.</p>
                  </div>
                </li>
              </ul>
            ...
            data-aos="fade-up"
              ...
              <div
                ref={cardRef}
                className="relative overflow-hidden rounded-[20px] max-w-[408px] w-full bg-gradient-to-br from-[#76463ab1] via-[#231625] to-[#110C22] border border-white/10 p-8"
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    background: cardState.size
                      ? `radial-gradient(${cardState.size}px at ${cardState.x}px ${cardState.y}px, rgba(118, 70, 58, 0.65), rgba(35, 22, 37, 0.4), rgba(17, 12, 34, 0.4), transparent 150%)`
                      : 'transparent',
                  }}
                />

                <p className="mb-8 text-shades-soft-gray italic text-[1.07rem] font-[400] text-[#C4C2C4] tracking-tight relative z-10">
                ...
                <div className="flex items-center gap-5 relative z-10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-shades-lavender-gray text-[0.87rem] text-[#C4BBD3]">Senior Product Manager</p>
                  </div>
                </div>
          ...
          data-aos="fade-up"
            ...
            <div className="mt-6 w-[13%] min-w-[32px] max-w-[80px]">
              <Image
                src="/images/SOC_2_badge_150px_1c485c7e5c.png"
                alt="SOC 2 Compliant"
                width={150}
                height={150}
                layout="responsive"
            ...
            <div className="mt-6 w-[13%] min-w-[32px] max-w-[80px]">
              <Image
                src="/images/gdpr_d6b92d85f1.svg"
                alt="GDPR Compliant"
                width={150}
                height={150}
                layout="responsive"
            ...
            <div className="mt-6 w-[13%] min-w-[32px] max-w-[80px]">
              <Link href="/legal/#security" className="block hover:opacity-85 transition-opacity">
                <Image
                  src="/images/legal_security_6524969a52.svg"
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-8 md:py-5 lg:py-2 relative z-10">
        ...
        data-aos="fade-up"
                                  data-aos-duration="1000"
                                  data-aos-delay="400">
          <div className="relative max-lg:overflow-hidden bg-gradient-to-b from-[#422c32bb] to-[#0E0918] rounded-2xl"
            ref={sectionRef}
            ...
            <div
              ...
              style={{
                ...
                background: sectionState.size
                  ? `radial-gradient(${sectionState.size}px at ${sectionState.x}px ${sectionState.y}px, #D57752,#7E4569 , transparent 30%)`
                  : 'transparent',
              }}
            />
            ...
            <div className="overflow-hidden rounded-2xl border-1 border-white/30 backdrop-blur-[0px] relative">
              ...
              <div className="relative z-10 px-4 sm:px-8 md:px-16 pb-16 mt-[-60px]">
                <header className="flex flex-col mb-8 gap-y-6 items-center m-auto">
                  {/* Badge */}
                  <div className="h-8 relative flex py-1 pr-2.5 pl-1 items-center gap-1.5 border border-white/10 rounded-[44px] bg-gradient-to-bl from-[#8D5872] to-[#BE726A] backdrop-blur-md text-white text-xs cursor-text w-fit">
                    <span className="flex w-6 h-6 justify-center items-center rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="text-white bg-gradient-to-br from-[#EC783F] to-[#C6454B] rounded-full" width="23" height="23" viewBox="0 0 14 20" fill="none">
                        <g fill="#FFFBE6">
                          <path d="M2.36133 10.81C2.36133 10.6733 2.42057 10.5343 2.53906 10.393L8.5 2.96916C8.65039 2.78231 8.81217 2.69116 8.98535 2.69572C9.15853 2.70028 9.29297 2.77319 9.38867 2.91447C9.48893 3.05118 9.49349 3.23575 9.40234 3.46818L7.4541 8.73868H11.1592C11.3005 8.73868 11.4144 8.78198 11.501 8.86857C11.5921 8.95516 11.6377 9.06225 11.6377 9.18986C11.6377 9.32657 11.5807 9.46785 11.4668 9.61368L5.50586 17.0307C5.35547 17.2175 5.19141 17.3087 5.01367 17.3041C4.84049 17.3041 4.70605 17.2335 4.61035 17.0922C4.51465 16.9509 4.51009 16.7641 4.59668 16.5316L6.55176 11.2612H2.84668C2.7054 11.2612 2.58919 11.2179 2.49805 11.1313C2.4069 11.0447 2.36133 10.9376 2.36133 10.81Z" />
                        </g>
                      </svg>
                    </span>
                    <span className="text-white/90 font-normal text-sm">n8n embed</span>
                  </div>
                ...
                <div className="flex justify-center">
                  <Link href="#" className="btn bg-gradient-to-br from-[#2082CE] via-[#2b2bee] to-[#3E4ADD] text-white font-medium py-3 px-8 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/30 flex items-center justify-center w-fit transform hover:scale-105">
                    Explore n8n embed
                  </Link>
                </div>
              </div>
        ...
        data-aos="fade-up"
          ...
          <div className="relative max-lg:overflow-hidden">
            <div className="relative flex w-full flex-col items-center justify-center overflow-visible">
              ...
              >
                <div className="mb-0 flex w-full items-center justify-center overflow-hidden rounded-[1.2rem] bg-gradient-to-b from-[#422935] via-[#0E0918] to-[#0E0918] relative">
                  {/* Gradient overlay */}
                  <div
                    ...
                    style={{
                      ...
                      background: ctaMouseState.size
                        ? `radial-gradient(${ctaMouseState.size}px at ${ctaMouseState.x}px ${ctaMouseState.y}px, rgba(253, 110, 29, 0.6), rgba(254, 38, 7, 0.7), transparent 30%)`
                        : 'transparent',
                    }}
                  />
                  <div className="relative flex w-full flex-col items-center justify-center px-[10%] py-16 md:py-20 lg:py-24 z-10">
                    ...
                    <div className="text-lg md:text-[1.3rem] text-white mb-6 max-w-[520px] text-center lg:mx-auto lg:mb-10">
                      <p>
                        ...
                        Skeptical? <strong className="font-[600] p-1 bg-gradient-to-r from-[#FC953B] via-[#EA7C89] to-[#B758AA] bg-clip-text text-transparent">Try it out</strong>, and see for yourself.
                      </p>
                    </div>

                    {/* CTA Button */}
                    <div className="flex justify-center">
                      <Link href="/" className="btn bg-gradient-to-r from-[#FD6E1D] via-[#FE5114] to-[#FE2607] text-white font-medium py-3 px-8 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/30 flex items-center justify-center w-fit transform hover:scale-105" >
                        Start building
                      </Link>
                    </div>
                  </div>

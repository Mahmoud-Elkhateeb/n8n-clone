      ...
      <nav className={`fixed top-1 w-[99%] z-50 transition-all duration-500 bg-black text-[#ACA4B9] shadow-md border border-gray-800 rounded-sm ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="flex items-center justify-between px-4 py-3 md:px-6">
          ...
          <div className="hidden xl:flex items-center space-x-4">
            ...
            <Link href="/" className="bg-orange-600 px-4 py-2 text-white rounded hover:bg-orange-700 transition-all duration-500">Get Started</Link>
          </div>
          ...
          {mobileOpen && (
            ...
            >
              ...
              <div className="pt-2 border-t border-gray-700 flex flex-col space-y-2">
                ...
                <button className="bg-orange-600 px-4 py-2 rounded hover:bg-orange-700 text-white text-center">Get Started</button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
